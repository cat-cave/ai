...
export const Route = createFileRoute(
  '/_structured-output/api/structured-output-snippets',
)({
  server: {
    handlers: {
      GET: async () => {
        try {
          ...
          console.error(
            '[API Structured Output Snippets] Error loading snippets:',
            error,
          )
          return new Response(
      ...
      DELETE: async ({ request }) => {
        try {
          ...
          console.error(
            '[API Structured Output Snippets] Error deleting snippet:',
            error,
          )
          return new Response(
