...
/**
 * CLI for testing the TanStack AI Code Mode Snippets system
 *
 * Commands:
...
async function runCommand(options: {
  ...
  console.log('╔═══════════════════════════════════════════════════════════╗')
  console.log('║     TanStack AI Code Mode Snippets - Multi-Adapter Tests    ║')
  console.log('╚═══════════════════════════════════════════════════════════╝')
  ...
  console.log('🚀 Starting snippets tests')
...
const program = new Command()
  .name('snippets-test')
  .description('Test the TanStack AI Code Mode Snippets system')
  .version('0.0.1')
