/**
 * Test utilities for the snippets CLI tests
 */
 ...
 */
export function createTestStorage(): SnippetStorage {
...
/**
 * Expected code for the snippet that wraps add_numbers
 */
export const EXPECTED_SNIPPET_CODE = `
const { a, b } = input;
...
/**
 * Expected input schema for the add_two_numbers snippet
 */
...
/**
 * Expected output schema for the add_two_numbers snippet
 */
export const EXPECTED_SNIPPET_OUTPUT_SCHEMA = {
  type: 'object',
  properties: {
